            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="<?=base_url('backend/career_admin_c/add_career')?>" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="date" name="career_start_date" required="required" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="date" name="career_end_date" required="required" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        ...
                                        <textarea name="career_description" id="descr" style="display:none;"></textarea>
                                        <br />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-1">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" class="flat" checked name="career_published" value="1"> Yes
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-1">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" class="flat" name="career_published" value="0"> No
                                                </label>
                                            </div>
                                        </div>
                                    </div>
