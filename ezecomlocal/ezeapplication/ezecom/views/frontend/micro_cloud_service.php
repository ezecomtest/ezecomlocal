...
<h2>Microsoft Cloud Service</h2>
<div class="row">
<div class="col-sm-2">&nbsp;</div>
<div class="col-xs-12 col-sm-12 col-md-8">
<p style="font-size: 14px;">Microsoft Cloud Service Packages are designed to support business critical functions and offer high speed connectivity and reliable access.</p>
<p style="font-size: 14px;">Microsoft Cloud Service Packages allow you to send and receive large amount of data, conduct video conferences, run web based applications, stream video and any mission critical applications.</p>
<p style="font-size: 14px;">Microsoft Cloud Service packages give you the highest level of performance delivered over our highly dependable and redundant infrastructure with 24-hour network monitoring and customer support included.</p>
